...
public class OffersDAO {
	...
	public List<Offer> getOffers() {
		...
		MapSqlParameterSource params = new MapSqlParameterSource("name", "Jasiu");
	...
	public boolean delete(String name) {
		...
		return jdbc.update("delete from offers where name=:name", params) == 1;
	}

	public Offer getOffers(int id) {

		MapSqlParameterSource params = new MapSqlParameterSource("id", "Sue");
